...
namespace AutomationFramework.Pages.IOSPages.Trackers
{
    class Page_IWeightTracker
    {
        String pageName;
        ...
        /// </summary>
        public Page_IWeightTracker()
        {
            pageName = this.GetType().Name;
            Console.WriteLine("Current class : " + pageName);
        }
        public Page_IWeightTracker(SoftAssertions softAssertions) : this()
        {
