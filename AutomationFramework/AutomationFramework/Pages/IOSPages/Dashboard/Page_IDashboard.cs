...
namespace AutomationFramework.Pages.IOSPages.Dashboard
{
    class Page_IDashboard
    {
        String pageName;
        ...
        /// </summary>
        public Page_IDashboard()
        {
            pageName = this.GetType().Name;
            Console.WriteLine("Current class : " + pageName);
        }

        public Page_IDashboard(SoftAssertions softAssertions) : this()
        {
