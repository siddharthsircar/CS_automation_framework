...
{
    public class Page_ManageStressCourse
    {
        String pageName;
        ...
        /// </summary>
        public Page_ManageStressCourse()
        {
        ...
        private void ClickManagingStressCourse()
        {
            SeleniumKeywords.Click(pageName, "managingstress");
        }
        ...
        /// </summary>
        public void CompleteManagingStressCourse()
        {
            ClickManagingStressCourse();
            TakeCourse();
