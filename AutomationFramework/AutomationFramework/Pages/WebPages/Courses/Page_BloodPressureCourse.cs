...
{
    public class Page_BloodPressureCourse
    {
        String pageName;
        ...
        /// </summary>
        public Page_BloodPressureCourse()
        {
        ...
        private void ClickBloodPressureCourse()
        {
            System.Threading.Thread.Sleep(2000);
            SeleniumKeywords.Click(pageName, "bloodpressure");
        }
        ...
        /// </summary>
        public void CompleteBloodPressureCourse()
        {
            ClickBloodPressureCourse();
            TakeCourse();
