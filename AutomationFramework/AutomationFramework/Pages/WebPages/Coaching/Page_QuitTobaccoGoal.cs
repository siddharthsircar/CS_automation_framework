...
namespace AutomationFramework.Pages.WebPages.Coaching
{
    class Page_QuitTobaccoGoal
    {
        ...
        public Page_QuitTobaccoGoal()
        {
            pageName = this.GetType().Name;
            Console.WriteLine("Current class : " + pageName);
        }
        public Page_QuitTobaccoGoal(SoftAssertions softassertions) : this()
        {
            this.softassertions = softassertions;
        }
        private void ClickQuitTobaccoGoal()
        {
            SeleniumKeywords.Click(pageName, "quittobaccolbl");
        }
        ...
        public void InputTobaccoStatus()
        {
            ClickQuitTobaccoGoal();
            System.Threading.Thread.Sleep(3000);
            InputCurrentTobaccoStatus();
